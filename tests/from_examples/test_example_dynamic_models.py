#!/usr/bin/env python3
"""
Auto-generated tests for examples/example_dynamic_models.py

This file was automatically generated by example_test_generator.py
from examples/example_dynamic_models.py.
"""
...
example_file_path = os.path.join(os.path.dirname(__file__), '../../examples/example_dynamic_models.py')
spec = importlib.util.spec_from_file_location("example_module", example_file_path)
example_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(example_module)


class TestDynamic_Models:
    """Auto-generated tests for examples/example_dynamic_models.py"""
    ...
    def test_example_schema_generation(self):
        """Demonstrate JSON Schema generation."""
        # Run the example function - if it raises an exception, the test will fail
        example_module.example_schema_generation()
        # If no exception is raised, the test passes
        assert True
